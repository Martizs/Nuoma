...
@section('content')
    <div class="container">
        ...
        @endif
        <form action="{{ route('layouts.rasytiAtsiliepimaApieVartPost') }}" method="post" enctype="multipart/form-data">
        <div class="panel panel-default col-md-12">
            <input type="hidden" name="rev_id" value="{{ $user->id }}">
            <input type="hidden" name="statusas" value="vartotojas">
